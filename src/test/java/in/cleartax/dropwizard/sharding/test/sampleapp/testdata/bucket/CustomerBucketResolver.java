...
package in.cleartax.dropwizard.sharding.test.sampleapp.testdata.bucket;

import in.cleartax.dropwizard.sharding.resolvers.bucket.BucketResolver;
import in.cleartax.dropwizard.sharding.test.sampleapp.testdata.dao.CustomerToBucketMappingDAO;
