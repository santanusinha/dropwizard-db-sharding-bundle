...
import in.cleartax.dropwizard.sharding.test.sampleapp.testdata.bucket.CustomerBucketResolver;
import in.cleartax.dropwizard.sharding.test.sampleapp.testdata.entities.CustomerToBucketMapping;
import in.cleartax.dropwizard.sharding.test.sampleapp.testdata.entities.Order;
import in.cleartax.dropwizard.sharding.test.sampleapp.testdata.entities.OrderItem;
import in.cleartax.dropwizard.sharding.test.sampleapp.testdata.services.OrderService;
import in.cleartax.dropwizard.sharding.test.sampleapp.testdata.services.OrderServiceImpl;
